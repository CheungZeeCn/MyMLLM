...
from libs.models.MyEncoderDecoderModel2 import MyEncoderDecoderModel2
...
if __name__ == '__main__':
    # # 构造model
    # model = MyEncoderDecoderModel2.from_encoder_decoder_pretrained(
    #     encoder_model_path, decoder_model_path, encoder_cls=LayoutLMv3Model
    # )
    ...
    model = MyEncoderDecoderModel2.from_pretrained('/home/ana/data4/projects/MyMLLM/examples/checkpoint-1990')
    # exp = train_dataset
