OUTPUT_DIR=/home/ana/data4/output_models/MyMLLM/p2s_pretrain/stage0_longwiki_80w1e-2lr
...
python base_pretrain.py   \
  ...
  --output_dir $OUTPUT_DIR  \
   ...
   --lr_scheduler_type cosine  --warmup_steps 1000   --optim adafactor --learning_rate 1e-3 \
