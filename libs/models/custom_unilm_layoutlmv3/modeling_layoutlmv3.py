...
@dataclass
class MidLayoutLMv3ModelOutputWithPoolingAndCrossAttentions(BaseModelOutputWithPoolingAndCrossAttentions):
...
class CustomLayoutLMv3PreTrainedModel(PreTrainedModel):
    """
    An abstract class to handle weights initialization and a simple interface for downloading and loading pretrained
    models.
    """

    config_class = CustomLayoutLMv3Config
...
class CustomLayoutLMv3Model(CustomLayoutLMv3PreTrainedModel):
    """
    """
    ...
    def __init__(self, config, detection=False, out_features=None, image_only=False):
        ...
        assert not config.is_decoder and not config.add_cross_attention, \
            "This version do not support decoder. Please refer to RoBERTa for implementation of is_decoder."
        logger.info("GOOD! 加载了自定义的 unilm 版本 CustomLayoutLMv3Model")
        self.detection = detection
    ...
    def forward(
        ...
        return MidLayoutLMv3ModelOutputWithPoolingAndCrossAttentions(
...
class CustomLayoutLMv3ForTokenClassification(CustomLayoutLMv3PreTrainedModel):
...
class CustomLayoutLMv3ForQuestionAnswering(CustomLayoutLMv3PreTrainedModel):
    _keys_to_ignore_on_load_unexpected = [r"pooler"]
    _keys_to_ignore_on_load_missing = [r"position_ids"]
...
class CustomLayoutLMv3ForSequenceClassification(CustomLayoutLMv3PreTrainedModel):
    _keys_to_ignore_on_load_missing = [r"position_ids"]
